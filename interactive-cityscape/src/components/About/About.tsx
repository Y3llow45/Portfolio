  ...
  return (
    <section className="about" ref={setRef}>
      <h2>
        ...
        {language === 'deu' && 'Über mich'}
        {language === 'spa' && 'Sobre mí'}
      </h2>
      ...
      >
        ...
        <span className="selectable-text orange-text">
          hristovborislav45@gmail.com
        </span>

        <button className="btn-copy" onClick={copy}>
          <img className="btn-img" src="/images/copy.png" />
        </button>
      </motion.p>
    </section>
  )
